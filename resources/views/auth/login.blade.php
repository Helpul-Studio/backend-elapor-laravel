...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal"> -->
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="{{ url('logo-polri.png') }}" alt="" height="28">
                                        </a>
                                    </div>
                                    <div class="auth-content my-auto">
                                        ...
                                        <div class="mt-5 text-center">
                                            <p class="text-muted mb-0">Belum punya akun? <br> <a href="#"
                                                    class="text-primary fw-semibold"> Silahkah hubungi admin yang bersangkutan </a> </p>
                                        </div>
                                    </div>
        ...
        <!-- password addon init -->
        <script src="{{ url('admin-template/assets/js/pages/pass-addon.init.js') }}"></script>
