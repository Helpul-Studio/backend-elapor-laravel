    ...
    <div class="menu-content h-100" data-simplebar>
        <ul class="metismenu left-sidenav-menu">
            <li class="menu-label mt-0">Navigation</li>
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('report.all') }}"><i class="ti-briefcase"></i>Pekerjaan</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('report.isidentil') }}"><i class="ti-notepad"></i>Laporan</a></li>
